...
//       const payloadRaw: CreateOrderPayload = {
//         name: formData.name,
...
// export function AddOrderButton({ onSuccess }: { onSuccess?: () => void }) {
...
//   // Fill formData with order data when modal opens or order changes
//   useEffect(() => {
//     if (order && isOpen) {
//       setFormData({
//         name: order.name || "",
...
//         workingHours:
//           Array.isArray(order.workingHours) && order.workingHours.length === 2
//             ? order.workingHours
//             : ["07:00", "15:00"],
//         profileImage: order.profileImage || "",
//         category: order.category?._id || "",
//         subcategories: order.subcategories?.map((sc) => sc._id) || [],
//       });
//     }
//   }, [order, isOpen]);
...
//       const payloadRaw: Partial<CreateOrderPayload> = {
//         name: formData.name,
//         mobile: formData.mobile,
//         location: formData.location,
//         workingHours: formData.workingHours,
