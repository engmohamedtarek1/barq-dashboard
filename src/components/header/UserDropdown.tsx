...
export default function UserDropdown() {
  ...
  useEffect(() => {
    ...
    // Listen for storage changes to update admin data when profile is updated
    const handleStorageChange = () => {
      const updatedAdmin = getAdminData();
  ...
  return (
    <div className="relative">
      <button
        ...
        className="dropdown-toggle flex items-center text-white dark:text-gray-400"
      >
